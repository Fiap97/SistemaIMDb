...
<body>
	...
	<div class="container">
		...
		<form:form action="mostrarUsers" modelAttribute="usuarioShow" method="post">	
		...
		<br /> 
		<a href="editUsers?id=${show.getId()}"
							class="btn btn-info">Edit</a>
		<br /> 
		<br />
		<a class = "btn btn-secondary" href = "users" role = "button">GO BACK</a>
	</div>
</body>
</html>